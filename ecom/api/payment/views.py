...
gateway = braintree.BraintreeGateway(
    braintree.Configuration(
        ...
        merchant_id="zysj3ydm8fnvh3nd",
        public_key="cqtqqdznkyd5yy5x",
        private_key="e24ec86e04116f9d489de3dd8eafdeb1"
    )
)
...
def generate_token(request, id, token):
    if not validate_user_session(id, token):
        return JsonResponse({'error': 'session expired, please login again!'})
